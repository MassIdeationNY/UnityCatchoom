...
project.add_folder(curr_dir + "/Assets/Plugins/CraftAR-iOS/.libs/CraftARUnitySDK.bundle", parent=craftARSDKGroup)
project.add_folder(curr_dir + "/Assets/Plugins/CraftAR-iOS/.libs/CraftARUnitySDK.framework", parent=craftARSDKGroup)
